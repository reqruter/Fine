...
class TodosTest {
    ...
    @Test
    public void testSearchWhenTasksNotFounded() {
        SimpleTask simpleTask = new SimpleTask(5, "Брат");
        ...
        Task[] actual = todos.search("Брат");
        Assertions.assertArrayEquals(expected, actual);
    }

    @Test
    public void testSearchWhenOneTasksFounded() {
